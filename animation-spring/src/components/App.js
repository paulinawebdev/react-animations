    ...
    <Router>
      <div className="app">
        <header className="header">
          <div className="header-left">
            ...
            <div className="nav-links">
              ...
              <a href="/nexon" className="nav-link">Nexon</a>
              <a href="/" className="nav-link">Esports</a>
            </div>
          </div>
        ...
        <Route exact path="/" render={props =>
          <Spotlight {...props} theme="overwatch" items={blizzardCharInfo} />
          } />
        <Route exact path="/nexon" render={props =>
          <Spotlight {...props} theme="nexon" items={mapleCharInfo} />
          } />
